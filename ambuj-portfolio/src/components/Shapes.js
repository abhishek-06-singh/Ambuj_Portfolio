...
export function Lights() {
  return (
    <>
      ...
      <spotLight color="#fff" position={[-10, 0, 15]} intensity={0.8} />
      <spotLight color="#fff" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#fff" position={[5, -10, 5]} intensity={0.8} />
      <spotLight color="#fff" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#fff" position={[15, 10, 5]} intensity={1} />
    </>
  );
}
